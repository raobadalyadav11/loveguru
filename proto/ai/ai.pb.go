...
type ChatRequest struct {
	...
	Context       string                 `protobuf:"bytes,2,opt,name=context,proto3" json:"context,omitempty"` // relationship type, previous session id
...
func (x *ChatMessage) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
const file_proto_ai_proto_rawDesc = "" +
	"\n" +
	"\x0eproto/ai.proto\x12\vloveguru.ai\"A\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x18\n" +
	"\acontext\x18\x02 \x01(\tR\acontext2\x8e\x01\n" +
	"\tAIService\x12;\n" +
	"\x04Chat\x12\x18.loveguru.ai.ChatRequest\x1a\x19.loveguru.ai.ChatResponse\x12D\n" +
	"\n" +
	"ChatStream\x12\x18.loveguru.ai.ChatMessage\x1a\x18.loveguru.ai.ChatMessage(\x010\x01B\x13Z\x11loveguru/proto/aib\x06proto3"
...
var file_proto_ai_proto_goTypes = []any{
	(*ChatRequest)(nil),  // 0: loveguru.ai.ChatRequest
	(*ChatResponse)(nil), // 1: loveguru.ai.ChatResponse
	(*ChatMessage)(nil),  // 2: loveguru.ai.ChatMessage
}
var file_proto_ai_proto_depIdxs = []int32{
	0, // 0: loveguru.ai.AIService.Chat:input_type -> loveguru.ai.ChatRequest
	2, // 1: loveguru.ai.AIService.ChatStream:input_type -> loveguru.ai.ChatMessage
	1, // 2: loveguru.ai.AIService.Chat:output_type -> loveguru.ai.ChatResponse
	2, // 3: loveguru.ai.AIService.ChatStream:output_type -> loveguru.ai.ChatMessage
